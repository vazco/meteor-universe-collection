 ...
 * @param direct tells if UniDoc should be directly linking or by extend method if exists on class.
 * @see UniDoc
 */
UniCollection.prototype.setConstructor = function (docConstructor, direct) {
    var self = this;
