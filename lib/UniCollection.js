...
UniCollection = class UniCollection extends Meteor.Collection {
    ...
    constructor (name:String, options:Object = {}, ...args) {
        if (!name) {
     ...
     * @see UniDoc
     */
    setDocumentClass(docClass, direct:Boolean = false) {
        if (!direct) {
        ...
        this._transform = doc => new this._documentClass(doc);
    }
     ...
     */
    addNewAllowDenyValidatorType(name:String) {
     ...
     * @returns {boolean}
     */
    validateUniverseRule(type:String, ...args) {
    ...
    static isDocumentFromCollection(doc, collectionName:String) {
