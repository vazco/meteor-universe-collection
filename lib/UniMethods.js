 ...
 * @returns {any}
 */
UniCollection.prototype.methods = function (methods:Object, isOverride) {
 ...
 * @param {Function} args[args.length - 1] Optional callback
 */
UniCollection.prototype.apply = function (name:String, ...args) {
 ...
 * @returns {*}
 */
UniCollection.prototype.docMethods = function (methods:Object, isOverride:Boolean = false) {
    this._methodHandlersToCall = this._methodHandlersToCall || {};
    var self = this;
