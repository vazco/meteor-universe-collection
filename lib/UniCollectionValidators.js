...
UniCollection.prototype.validateUniverseRule = function(){
    ...
    var self = this;
    if((denyFns && denyFns.length && _.some(denyFns, function(fn){ return fn.apply(self, args);})) ||
        !_.some(allowFns, function(fn){ return fn.apply(self, args);})){
...
UniCollection.prototype._takeUniverseValidators = function (allowOrDeny, options) {
    var adTypes = _.union(_.keys(this._methodHandlersToCall || {}), this._universeAllowDenyTypes || []);
    var self = this;
